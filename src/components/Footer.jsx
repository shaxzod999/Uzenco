function Footer() {
  return (
    <section className="w-full bg-[#343438] text-[#fff] overflow-hidden">
      <div className="max-w-[1280px] w-full mx-auto mx-auto">
        ...
        <footer className="hidden box-border md:flex flex-col justify-end items-start pt-36 pb-10 max-md:pt-20 max-md:pb-10 max-sm:pt-10 max-sm:pb-5">
          ...
          <div className="flex flex-col justify-end items-start pt-20 w-full">
            <div className="flex gap-0 items-start w-full">
              <div className="flex flex-1 items-end pt-11 pr-4 pb-0 pl-0 border-t border-r border-solid border-r-zinc-300 border-t-zinc-300 max-sm:pt-8 max-sm:pr-5 max-sm:pb-0 max-sm:pl-0">
                <div className="flex flex-col items-start">
                  <div className="max-w-[887px] whitespace-nowrap text-8xl tracking-tighter text-white uppercase leading-[96px] max-md:text-6xl max-md:leading-[64px] max-sm:text-4xl max-sm:tracking-tighter max-sm:leading-9">
                    +7 (967) 000 00 00
                  </div>
                </div>
              </div>

              <div className="flex gap-40 items-end pt-11 pr-0 pb-5 pl-8 border-t border-solid border-t-zinc-300 max-w-[829px] max-md:gap-20 max-md:px-0 max-md:pt-11 max-md:pb-5 max-md:w-full max-sm:flex-col max-sm:gap-10 max-sm:items-start max-sm:px-0 max-sm:pt-8 max-sm:pb-4">
                <div className="flex flex-col items-start">
                ...
                <div className="flex flex-col items-start">
                  <div className="text-lg leading-5 text-zinc-300 max-w-[191px] max-sm:w-full max-sm:text-base max-sm:leading-5">
                    Russia, Moscow, <br /> Example Street, 25
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="w-full flex flex-col items-end justify-end pt-16 max-sm:pt-10">
              <div className="flex gap-0 items-end w-full">
                <div className="flex gap-40 items-end pr-2 w-[987px] max-md:flex-col max-md:gap-20 max-md:items-start max-md:w-full max-sm:gap-10">
                ...
                <div className="flex gap-[80px] items-end pl-4 max-w-[987px] max-md:flex-col max-md:gap-20 max-md:items-start max-md:w-full max-sm:gap-10">
                  <div className="flex flex-col items-start">
            ...
            <div className="flex flex-col items-start pt-36 w-full max-sm:pt-20">
              <div className="flex gap-0 justify-center items-start w-full">
                ...
                <div className="flex items-end pl-16 w-[590px] max-md:w-full">
                  <div className="flex flex-col items-start">
